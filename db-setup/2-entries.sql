...
insert into user_role (id,role) values (1,'ROLE_DEFAULT');
insert into user_role (id,role) values (2,'ROLE_CONTRIBUTOR');
insert into user_role (id,role) values (3,'ROLE_EDITOR');
insert into user_role (id,role) values (4,'ROLE_ADMIN');


insert into users (id, username, password, enabled, role_id) values (1,'default', 'c21f969b5f03d33d43e04f8f136e7682', TRUE, 1);
insert into users (id, username, password, enabled, role_id) values (2,'contributor', 'bba2348631bbaef062b73dde6b38fdc1', TRUE, 2);
insert into users (id, username, password, enabled, role_id) values (3,'editor', '5aee9dbd2a188839105073571bee1b1f', TRUE, 3);
insert into users (id, username, password, enabled, role_id) values (4,'admin', '21232f297a57a5a743894a0e4a801fc3', TRUE, 4);
