...
<div id="main" class="container theme-showcase clearfix">
	...
	<div class="page-header">
		<h1 class="col-sm-offset-2"><spring:message code="page.edit.computer.title"/></h1>
	</div>
	...
	<div class="">
		<form:form cssClass="form-horizontal clearfix" commandName="cdto"
			...
			<div class="col-sm-offset-2 col-sm-10 actions">
				<spring:message code="page.edit.submit" var="submitButtonLabel"/>
				<input type="submit" value="${submitButtonLabel}" class="btn btn-primary">
				<spring:message code="page.edit.or"/> <a href="dashboard" class="btn btn-default"><spring:message code="page.edit.cancel"/></a>
			</div>
